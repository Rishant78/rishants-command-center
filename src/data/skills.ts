...
export const skillTree: SkillBranch[] = [
  {
    ...
    skills: [
      ...
      { name: "C", projects: [] },
      { name: "SQL", projects: ["player-analytics"] },
    ],
  },
  {
    id: "backend",
  ...
  },
  {
    ...
    skills: [
      { name: "Unity", projects: ["multiplayer-fps", "2d-platformer", "focus-run"] },
  ...
  },
  {
    ...
    name: "Cloud",
    skills: [
      { name: "AWS", projects: ["ai-video-captioning"] },
      { name: "Azure", projects: [] },
    ],
  },
  {
    ...
    skills: [
      { name: "Git", projects: ["multiplayer-fps", "ai-video-captioning"] },
      { name: "GitHub", projects: ["2d-platformer", "focus-run"] },
    ],
  },
];
